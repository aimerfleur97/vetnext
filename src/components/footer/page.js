...
const Footer = () => {
    return (
        <footer
            class="bg-zinc-50 text-center text-surface/75 text-white/75 lg:text-left bg-gray_dark">
            <div
            ...
            <div class="mx-6 py-10 text-center md:text-left">
                <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                    <div class="">
                        ...
                        <p>
                        Welcome to our Vetnext! <br/> Our dedicated vets are ready to care for your pets. Book now and keep those tails wagging!
                        </p>
                    </div>
                </div>
            </div>
